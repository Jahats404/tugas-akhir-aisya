...
<body>
    <div class="email-container">
        ...
        <p>Halo,</p>
        <p>Anda menerima email ini karena kami menerima permintaan pengaturan ulang kata sandi untuk akun Anda. Anda
            dapat mengatur ulang kata sandi Anda melalui tautan di bawah ini:</p>
        {{-- <p>Hi {{ $user->name }},</p> --}}
