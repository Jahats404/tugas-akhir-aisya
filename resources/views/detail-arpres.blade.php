                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 m-auto">
                            ...
                            <p><strong>There are so many ways to make money online</strong>. Below are several platforms you can use to find success. Keep in mind that there is no one path everyone can take. If that were the case, everyone would have a million dollars.</p> --}}
                                ...
                                <blockquote>
                                    Arsip Prestasi {{ $arpres->nama }}
                                </blockquote>
                                <div class="row my-4">
                                    @foreach ($arpres->detailArpres as $dt)    
                                ...
                                <div class="arpres-details">
                                    <h5>Detail Arsip</h5>
                                    <p><strong>Nama:</strong> {{ $arpres->nama }}</p>
                                    <p><strong>Wilayah:</strong> {{ $arpres->wilayah }}</p>
                                    <p><strong>Kategori:</strong> {{ $arpres->kategori }}</p>
                                    <p><strong>Deskripsi:</strong> {{ $arpres->deskripsi }}</p>
                                </div>
                        </div>
